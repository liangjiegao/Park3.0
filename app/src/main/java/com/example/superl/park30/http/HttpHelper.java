package com.example.superl.park30.http;
...
/**
 * Created by SuperL on 2018/8/23.
 */
...
public class HttpHelper {
    ...
    /**
     * get请求， 返回字符串内容
     * @param url 访问服务器的url地址
     * @return     返回一个封装了反回结果的类
     */
    ...
    public static class HttpResult{
        ...
        private HttpResult(HttpResponse response, HttpClient httpClient, HttpRequestBase requestBase){
            mResponse = response;
        ...
        /**
         * 从结果中获取字符串， 一旦获取， 会自动关流， 并且把字符串保存， 方便下次使用
         */
